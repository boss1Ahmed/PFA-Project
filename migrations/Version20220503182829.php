 ...
 */
final class Version20220503182829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE tele tele VARCHAR(255) DEFAULT NULL');
    }
